...
from apps.api.schemas.delivery_partner import DeliveryPartnerCreate
from apps.core.exceptions import DeliveryPartnerNotAvailable
from apps.database.models import DeliveryPartner, Location, Shipment
